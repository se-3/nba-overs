    ...
    <main className="min-h-screen p-6 max-w-4xl mx-auto">
      ...
      <div className="mt-6 jam-card rounded-2xl p-6">
        <div className="flex items-center justify-between">
          <h1 className="jam-font text-lg jam-neon">
            NBA JAM GROUP CHAT STANDINGS
          </h1>
          ...
          <table className="w-full jam-table text-sm">
            ...
            <tbody>
              ...
              {!loading && !data?.leaderboard?.length && (
                <tr>
                  <td colSpan={5} className="py-4 opacity-80">
                    No data available.
                  </td>
                </tr>
              )}
        ...
        <div className="mt-6 text-xs opacity-80">
          Rankings are based on projected OVER/UNDER outcomes using current win pace.
        </div>
      </div>
    </main>
  );
